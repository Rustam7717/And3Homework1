...
import com.example.and3lesson1.data.remote.OnFilmReadyCallBack;
import com.example.and3lesson1.databinding.FragmentFilmsBinding;
...
public class FilmsFragment extends Fragment {
    ...
    private void setupRecyclerView(){
        binding.recyclerFilms.setLayoutManager(new LinearLayoutManager(getContext()));
